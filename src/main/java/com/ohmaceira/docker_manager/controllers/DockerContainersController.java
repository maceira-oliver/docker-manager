package com.ohmaceira.docker_manager.controllers;

import com.github.dockerjava.api.model.Container;
import com.ohmaceira.docker_manager.services.DockerService;
...
public class DockerContainersController {
    ...
    @DeleteMapping("/{id}")
    public void deleterContainer(@PathVariable String id) {
